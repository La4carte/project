...
Student ID :<input class="form-control" type="text" placeholder="Enter Student ID" name="Id number" required/>
<br>
...
Username  <input type="text" name="username" id="name" placeholder="Enter  username " required/>
  <label id="icon" for="name"></label>
Student ID <input type="UniversityID" name="name" id="name" placeholder="Enter Student ID" required/>
  <label id="icon" for="name"></label>
