...
<div class="container">
<form   action="logchekstud.php" method="POST">

Student ID :<input  type="text" pattern="[0-9]{9}"placeholder="Enter Student ID" name="STUDENTID" required/>
<br>
...
Username  <input type="text" name="USERNAME" id="name" placeholder="Enter  username " pattern="(?=.[a-z])(?=.*[A-Z]).{4,8}" required/>
  <label id="icon" for="name"></label>
Student ID <input type="UniversityID" name="STUDENTID" pattern="[0-9]{9}"id="name" placeholder="Enter Student ID" required/>
  <label id="icon" for="name"></label>
