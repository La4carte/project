    ...
    <nav class="navbar navbar-expand-md no-gutters">
      <div class="col-2 text-left">
          <img src="logo.jpeg" alt="" width="200" height="156"  class="center"/>
              ...
              <!--مربع الاسم -->
 <div class="lacarte">
      <button onclick="document.getElementById('id01').style.display='block'" style="width:150px ; height:60px ;margin-left:380px ; margin-top:0px ; border-radius:10px ;"><h5>LA CARTE</h5></button>
...
<div class="container">
<form name="myform1" action="admindata.php" method="POST">

NAME<input class="form-control" type="text" placeholder="Enter  name" name="NAME" required/>
<br>

Password :<input class="form-control"  type="password" name="PASSWORD" placeholder="Enter Password" required/>
<br>
<button class="btn" style="background-color:#67cca5 ;color:white; width:150 ; height:60; border-radius:10px ;" type="submit" value="Check In" name="Submit" onclick= "validate()" name="register"  > Login </button>
</form>
</div>
<script>
...
var count = 2;
function validate() {
var un = document.myform1.NAME.value;
var pw = document.myform1.PASSWORD.value;
var valid = false;

var unArray = ["Albandari", "Ebtehal", "Elaf", "Fedeiah", "Haneen", "Mona"];
var pwArray = ["albandari381006608", "ebtehal381006689", "elaf381007915", "fedeiah381011207", "haneen381008583", "mona381010581"]; 
...
document.myform1.NAME.value = "";
document.myform1.PASSWORD.value = "";
setTimeout("document.myform1.NAME.focus()", 25);
setTimeout("document.myform1.PASSWORD.select()", 25);
count --;
}

else {
alert ("Still incorrect! You have no more tries left!");
document.myform1.NAME.value = "No more tries allowed!";
document.myform1.PASSWORD.value = "";
document.myform1.NAME.disabled = true;
document.myform1.PASSWORD.disabled = true;
return false;
}
